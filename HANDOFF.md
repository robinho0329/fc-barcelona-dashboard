...
`views/msn.py` 맨 아래에 **"그 전의 삼각편대 — 메시 · 비야 · 페드로"** 구역을
붙였다. MSN과 같은 기준(FBref 전 대회 합산)으로 잰다.
...
2시즌 164골, 팀 득점(269골)의 **61.0%**. 시즌별로는 2010/11 66.9%(83/124),
2011/12 55.9%(81/145)로 비야가 2011년 12월 정강이 골절로 빠진 뒤 떨어진다.
MSN과는 시즌 수가 달라 **시즌당 득점**으로 맞춰 나란히 그렸다.

**아직 없는 것: MVP의 내부 삼각형(누가 누구에게).**
